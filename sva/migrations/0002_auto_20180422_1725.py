# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-04-22 17:25
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tipo', models.PositiveIntegerField(choices=[(5, 'Aprovação de Vaga'), (2, 'Cadastro de Professor'), (6, 'Vaga de Interesse'), (1, 'Indicação de Vaga'), (4, 'Cadastro de Vaga'), (7, 'Solicitação de Área de Atuação'), (8, 'Nova Mensagem no Fórum'), (9, 'Resposta no Fórum'), (3, 'Cadastro de Empresa')], verbose_name='Tipo da Notificação')),
                ('data_cadastro', models.DateTimeField(auto_now_add=True, verbose_name='Data de Cadastro')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descricao', models.TextField(db_index=True, verbose_name='Descrição')),
        ...
        migrations.AlterField(
            model_name='campus',
            name='cidade',
            field=models.CharField(choices=[('DIVINOPOLIS', 'Divinópolis'), ('ARAXA', 'Araxá'), ('LEOPOLDINA', 'Leopoldina'), ('NEPOMUCENO', 'Nepomuceno'), ('BELO HORIZONTE', 'Belo Horizonte'), ('CONTAGEM', 'Contagem'), ('TIMOTEO', 'Timóteo'), ('VARGINHA', 'Varginha'), ('CURVELO', 'Curvelo')], max_length=45),
        ),
        migrations.AlterField(
            model_name='curso',
            name='nivel_ensino',
            field=models.IntegerField(choices=[(4, 'DOUTORADO'), (3, 'MESTRADO'), (5, 'ESPECIALIZACAO'), (1, 'TECNICO'), (2, 'GRADUACAO')], verbose_name='Nível de Ensino'),
        ),
        migrations.AlterField(
            model_name='curso',
            name='nome',
